 ...
 * @version $Id: ISOUtil.java 2921 2010-05-03 17:24:50Z apr $
 */
...
public class ByteUtil {
    ...
    */
    ...
    public static BitSet short2BitSet(short values[]) 
    {
    	BitSet bs = new BitSet();
    ...
    public static byte[] hex2byte (String s,boolean checkNull) 
    {
    	if(s == null && checkNull)
    		return null;
    	else
    ...
    public static int byte2HexLen(int len) 
    {
    	return len << 1;
    }
	...
	public static String convert2HexString(int value, int hexLen)
	{
		if(value<0)
			value = value + 256;
		String hexMti = Integer.toHexString(value).toUpperCase();
		String strVal = padleft(hexMti, hexLen, '0');
		hexMti = strVal.substring(strVal.length() - hexLen, strVal.length());
		return hexMti;
	}
	...
	public static String convert2HexString(byte[] b) {
		...
		for (int idx = 0; idx < b.length; idx++) {
			bf.append(convert2HexString(b[idx], 2));
		}
		return bf.toString();
	}
